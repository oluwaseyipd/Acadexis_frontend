...
const heatmapCourses = [
  {
    ...
    avgMastery: 78,
    topics: [
      { name: 'Red-Black Tree Rotations', queries: 94, confusionLevel: 'High', status: 'Needs Review' },
      { name: 'Dijkstra Shortest Path', queries: 41, confusionLevel: 'Medium', status: 'Moderate' },
      { name: 'Array vs Linked List', queries: 12, confusionLevel: 'Low', status: 'Mastered' },
      { name: 'Amortized Complexity Analysis', queries: 82, confusionLevel: 'High', status: 'Needs Review' }
    ]
  },
  {
    ...
    avgMastery: 72,
    topics: [
      { name: 'Entropy Generation in Open Systems', queries: 112, confusionLevel: 'High', status: 'Needs Review' },
      { name: 'Rankine Cycle Reheat Calculations', queries: 68, confusionLevel: 'Medium', status: 'Moderate' },
      { name: 'Ideal Gas Law Applications', queries: 15, confusionLevel: 'Low', status: 'Mastered' }
    ]
  },
  {
    ...
    avgMastery: 85,
    topics: [
      { name: 'Operon Regulation (Lac & Trp)', queries: 128, confusionLevel: 'High', status: 'Needs Review' },
      { name: 'DNA Polymerase Proofreading', queries: 53, confusionLevel: 'Medium', status: 'Moderate' },
      { name: 'Ribosome Assembly Structure', queries: 20, confusionLevel: 'Low', status: 'Mastered' }
    ]
  }
];
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 font-sans">
      ...
      <div className="bg-[#001733] text-slate-200 text-xs sm:text-sm py-2 px-4 border-b border-[#002855]">
      ...
      <section className="bg-[#002147] text-white pt-16 pb-20 sm:pb-28 px-4 sm:px-6 lg:px-8 border-b border-[#003366]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            ...
            <div className="lg:col-span-6 space-y-6">
              ...
              <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 pt-2">
                <Link
                  href="/auth/register"
                  className="inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-[#83FBA5] hover:bg-[#6ee791] text-[#002147] font-bold rounded-lg transition-colors text-base shadow-sm"
                >
                ...
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-[#001733] hover:bg-[#0a2f5c] text-white border border-slate-600 font-semibold rounded-lg transition-colors text-base"
                >
            ...
            <div id="platform-sandbox" className="lg:col-span-6">
              <div className="bg-[#001733] border-2 border-[#003366] rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div className="bg-[#000f24] px-4 py-3 border-b border-[#002855] flex flex-wrap items-center justify-between gap-2">
                  ...
                  <div className="flex items-center bg-[#002147] p-1 rounded-lg border border-[#003366]">
                    <button
                      onClick={() => setActiveTab('study')}
                      className={`px-3 py-1 text-xs font-medium rounded-md transition-colors ${
                        activeTab === 'study'
                          ? 'bg-[#83FBA5] text-[#002147] font-bold'
                ...
                {activeTab === 'study' && (
                  <div className="p-5 space-y-4 text-slate-200">
                          ...
                          <button
                            ...
                            className={`px-2.5 py-1.5 text-xs rounded-md border text-left transition-colors ${
                              selectedPrompt.id === p.id
                                ? 'bg-[#002147] border-[#83FBA5] text-[#83FBA5] font-semibold'
                    ...
                    {showCoordinateHighlight && (
                      <div className="bg-[#000f24] p-3 rounded-lg border border-[#003366] text-xs space-y-1.5">
                        <div className="flex items-center justify-between text-[11px] text-slate-400">
                          <span className="font-mono text-[#83FBA5]">📍 {selectedPrompt.citationCoordinate}</span>
                          <span className="text-slate-500">Official Courseware Index</span>
                        </div>
                ...
                {activeTab === 'heatmap' && (
                  <div className="p-5 space-y-4 text-slate-200">
                    ...
                    {/* Confusion Topic Breakdown List */}
                    <div className="space-y-2">
                      ...
                      {heatmapCourses[selectedCourseIdx].topics.map((t, idx) => (
                        <div
                          key={idx}
                          className="bg-[#002147] p-2.5 rounded-lg border border-[#003366] flex items-center justify-between text-xs"
                        >
                          <div>
                            <div className="text-white font-medium">{t.name}</div>
                            <div className="text-slate-400 text-[11px]">{t.queries} queries this week</div>
                          </div>
                          <span
      ...
      <section className="bg-white py-12 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6 items-center text-center">
            ...
            <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 flex flex-col items-center justify-center col-span-2 md:col-span-1">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50">
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Generic AI Card */}
            <div className="bg-white p-8 rounded-2xl border-2 border-red-200 space-y-6 shadow-sm">
              <div className="flex items-center justify-between">
            ...
            <div className="bg-[#002147] text-white p-8 rounded-2xl border-2 border-[#83FBA5] space-y-6 shadow-md">
              <div className="flex items-center justify-between">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-white border-t border-b border-slate-200">
        <div className="max-w-7xl mx-auto space-y-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            {/* Feature 1 */}
            <div className="bg-slate-50 p-6 rounded-xl border border-slate-200 flex flex-col justify-between space-y-4 hover:border-slate-400 transition-colors">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-slate-50">
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            {/* Role Toggle Tabs */}
            <div className="flex items-center bg-white p-1 rounded-xl border border-slate-300 shadow-sm mt-4">
              <button
              ...
              <button
                onClick={() => setActiveRole('lecturers')}
                className={`px-5 py-2 text-sm font-semibold rounded-lg transition-colors ${
          ...
          {activeRole === 'students' && (
            <div className="bg-white rounded-2xl border border-slate-200 p-8 lg:p-12 shadow-sm grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
              ...
              <div className="lg:col-span-6 relative h-[360px] rounded-xl overflow-hidden border border-slate-200">
                <Image
      ...
      <section className="bg-[#002147] text-white py-16 px-4 sm:px-6 lg:px-8 border-b border-[#003366]">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            ...
            <div className="space-y-2 p-4 rounded-xl bg-[#001733] border border-[#003366]">
              <div className="text-4xl sm:text-5xl font-extrabold text-[#83FBA5]">99.8%</div>
              <div className="text-sm font-semibold text-white">Citation Precision</div>
              <p className="text-xs text-slate-400">Verified against line coordinates</p>
            </div>

            <div className="space-y-2 p-4 rounded-xl bg-[#001733] border border-[#003366]">
              <div className="text-4xl sm:text-5xl font-extrabold text-[#83FBA5]">0%</div>
              <div className="text-sm font-semibold text-white">Speculative Hallucinations</div>
              <p className="text-xs text-slate-400">Strict syllabus boundary guard</p>
            </div>

            <div className="space-y-2 p-4 rounded-xl bg-[#001733] border border-[#003366]">
              <div className="text-4xl sm:text-5xl font-extrabold text-[#83FBA5]">4.2 hrs</div>
              <div className="text-sm font-semibold text-white">Saved Per Student / Wk</div>
              <p className="text-xs text-slate-400">Rapid source and formula lookup</p>
            </div>

            <div className="space-y-2 p-4 rounded-xl bg-[#001733] border border-[#003366]">
              <div className="text-4xl sm:text-5xl font-extrabold text-[#83FBA5]">68%</div>
              <div className="text-sm font-semibold text-white">Faster Gap Identification</div>
              <p className="text-xs text-slate-400">For lecturers before midterm exams</p>
            </div>
